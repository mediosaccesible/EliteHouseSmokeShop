...
This website project, including its source code, custom layout, structure, styling, animations, written content, design system, user interface, and custom implementation, is owned by **Medios Accesible/James-Boyden**.
...
Elite House Smoke Shop is authorized to use this website for its intended business website purpose.

This authorization does not transfer ownership of the underlying source code, design system, or custom implementation unless agreed to in writing by Medios Accesible.

## Unauthorized Use

Unauthorized copying, cloning, resale, redistribution, or reuse of this website’s code, design, layout, or custom implementation is strictly prohibited.
