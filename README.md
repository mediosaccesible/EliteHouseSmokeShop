...
This website project, including its source code, custom layout, structure, styling, animations, written content, design system, user interface, and custom implementation, is owned by **Medios Accesible**.
